...
import { Star, Hash, Gem, Clock, Flame } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="my-12">
            <SlokaCard
              sloka={`ప్రణమ్య శిరసాదేవం గౌరిపుత్రమ్ వినాయకం
                     భక్తా వాసం స్మరేనిత్యం ఆయుః కామార్థ సిద్ధయే||`}
          ...
          <div className="bg-card/80 p-10 md:p-14 rounded-2xl shadow-xl border border-secondary/20 space-y-8">
            ...
            <div className="max-w-8xl mx-auto space-y-4">
              <p className="text-lg md:text-xl font-playfair text-secondary leading-relaxed text-left">
                ...
                divine wisdom. “Astro” represents Surya — the source of light,
                clarity, and cosmic order. “Wak” (from Vāk) represents the
                divine speech of Lord Ganesha — wisdom, communication, and
              ...
              <p className="text-lg md:text-xl font-playfair text-secondary leading-relaxed text-left">
                ...
                poojas & homas, muhurtha selection, and spiritual rituals with
                compassion, clarity, and authenticity.
              </p>

              <p className="text-lg md:text-xl font-playfair text-secondary leading-relaxed text-left">
                Rooted in the symbolism of the <strong>Lotus</strong> (purity),
                <strong> Surya</strong> (illumination), and{" "}
                <strong>Ganesha</strong>
                (auspicious beginnings), AstroWak helps every seeker understand
                their energies, karmic patterns, and life direction with divine
                clarity.
              </p>
            </div>
            ...
            <div className="max-w-8xl mx-auto space-y-4">
              ...
              <p className="text-secondary font-playfair text-lg leading-relaxed text-left">
                In Vedic tradition, Surya is Pratyaksha Daivam — the visible God
                and the center of the Navagrahas. He symbolizes truth, vitality,
                illumination, and life force.
              </p>

              <ul className="text-secondary font-playfair text-lg leading-relaxed space-y-2 text-left">
                <li>
                  • <strong>Clarity</strong> — revealing the truth hidden in
                  one’s chart
                </li>
                <li>
                  • <strong>Vitality</strong> — energizing purpose and direction
                </li>
                <li>
                  • <strong>Illumination</strong> — awakening inner wisdom
                </li>
              </ul>

              <p className="text-secondary font-playfair text-lg leading-relaxed text-left">
                Just as the Sun sustains the cosmos, AstroWak sustains spiritual
                clarity and helps seekers align with cosmic harmony.
              </p>
            </div>
            ...
            <div className="max-w-8xl mx-auto space-y-5">
              ...
              <p className="text-secondary font-playfair text-lg leading-relaxed text-left">
                “Wak” (Vāk) is associated with Lord Ganesha as Vakpathaye — the
                Lord of Speech, Knowledge, and Conscious Understanding.
              </p>

              <ul className="text-secondary font-playfair text-lg leading-relaxed space-y-2 text-left">
                <li>
                  • <strong>Divine Communication</strong> — clarity in
                  expression
                </li>
                <li>
                  • <strong>Wisdom</strong> — interpreting cosmic messages
                </li>
                <li>
                  • <strong>Obstacle Removal</strong> — clearing emotional &
                  mental blocks
                </li>
              </ul>

              <p className="text-secondary font-playfair text-lg leading-relaxed text-left">
                “Wak” transforms astrology from information into meaningful
                spiritual conversation, helping seekers understand life with
                deeper awareness.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-12">
            {[
              ...
              >
                ...
                <div
                  className="flex-shrink-0 w-28 h-28 rounded-full bg-secondary/10 shadow-inner 
